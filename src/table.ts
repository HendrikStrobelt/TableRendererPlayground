...
module SVGTable {
    ...
    export class Element {
        ...
        constructor(public domId: string,
            ...
            this.div = <HTMLDivElement> <any>$('#' + domId);
        ...
        private updatePane(configuration: Configuration) {
            ...
            this.internalDiv.offsetWidth = configuration.columns.length * this.elementStyle.cellDimensions[0];
            this.internalDiv.offsetHeight = configuration.columns.length * this.elementStyle.cellDimensions[1];
        }
    }
